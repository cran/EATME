#' @title A two-sided EWMA-p control chart
#'
#' @description This function displays two-sided EWMA-p chart control charts based on in-control and out-of-control data that are number of defectives.
