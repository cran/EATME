#' @title A one-sided upper EWMA-p control chart
#'
#' @description This function displays one-sided upper EWMA-p chart control charts based on in-control and out-of-control data that are number of defectives.
